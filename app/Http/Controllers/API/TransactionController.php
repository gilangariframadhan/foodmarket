...
class TransactionController extends Controller
{
    public function all(Request $request)
    {
        ...
        $transaction = Transaction::with(['food', 'user'])->whare('user_id', Auth::user()->id); {
            if ($food_id) {
                $transaction->whare('food_id', $food_id);
            }
            if ($status) {
                $transaction->whare('$status', $status);
            }
    ...
    public function checkout(Request $request)
    {
        ...
        $midtrans = [
            'transaction' => [
                ...
                'gross_annont' => $transaction->total,
            ],
            'customer_details' => [
