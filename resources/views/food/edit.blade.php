                ...
                <form class="w-full" action="{{ route('food.update', $item->id) }}" method="POST"
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <p class="text-grey-600 text-XS italic">Dipisahkan dengan koma, Contoh : Bawang Merah,
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <p class="text-grey-600 text-XS italic">Dipisahkan dengan koma, Recomended, Populas, New,
                                Food</p>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
